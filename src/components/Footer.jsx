...
const Footer = () => {
  return (
    <footer className="bg-white dark:bg-black dark:text-white rounded-t-[4rem]">
      <div className="mx-auto max-w-screen-xl px-4 pb-6 pt-16 sm:px-6 lg:px-8">
        <div className="lg:flex lg:items-center lg:justify-between">
          <div className="flex justify-center text-teal-600 sm:justify-start dark:text-teal-300">
            ...
            <span className="ml-2 text-2xl items-center font-bold">
              Skill Circle
            </span>
          </div>

          <p className="mt-4 max-w-md text-center leading-relaxed text-gray-500 sm:text-left lg:mt-0 dark:text-gray-400">
            Connect with your neighbors, exchange skills, and build a stronger
            community. SkillCircle makes it easy to find help or offer your
            expertise within your neighborhood.
          </p>
        </div>

        <div className="mt-16 grid grid-cols-1 gap-10 border-t border-gray-100 pt-16 md:grid-cols-2 lg:grid-cols-4  dark:border-gray-800">
          ...
          <div className="text-center sm:text-left md:col-span-4 lg:col-span-2">
            ...
            <div className="mx-auto mt-8 max-w-md sm:ms-0">
              <p className="text-center leading-relaxed text-gray-500 ltr:sm:text-left rtl:sm:text-right dark:text-gray-400">
                Want to stay updated on the latest SkillCircle news, features,
                and community events? Subscribe to our newsletter for helpful
                tips, inspiring stories, and exclusive offers!
              </p>
