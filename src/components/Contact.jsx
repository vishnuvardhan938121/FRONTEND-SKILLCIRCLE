            ...
            <div className="flex flex-col text-white">
              ...
              <div className="flex my-4 w-2/3 lg:w-1/2">
                <a
                  ...
                  rel="noreferrer"
                  target="_blank"
                  className="text-black transition  hover:text-teal-700/75 dark:text-white dark:hover:text-teal-500"
                >
                ...
                <a
                  ...
                  rel="noreferrer"
                  target="_blank"
                  className="text-black transition ml-3 hover:text-teal-700/75 dark:text-white dark:hover:text-teal-500"
                >
